...
class AccountAnalyticLine(models.Model):
    ...
    hour_100 = fields.Float(
        string='Horas 100%'
    )
    r_hours_compensate = fields.Float(
        string='Horas compensadas',
    )
    ...
    is_validate_extra_hour = fields.Boolean(
        string='Validar Hora Extra'
    )
