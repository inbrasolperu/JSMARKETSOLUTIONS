...
class HrAttendance(models.Model):
    ...
    extra_hours = fields.Float(
        string=u'Horas Extras',
        readonly=True,
        help=u'Compara la jornada del trabajador “entrada y salida” con el campo minutos permitidos para horas extras '
             u'ubicado en configuración y si tiene una diferencia positiva que se puede considerar como horas extras '
             u'trae la información.'
    )
    hours_part = fields.Float(
        string='Parte de Horas',
        compute='compute_hours_part',
        store=True,
        help=u'Filtra al trabajador y el día en partes de horas y si tiene Horas extras registradas las trae.'
    )
