        ...
        for rec in self:
            ...
            if rec.type_identification_id:
                if rec.identification_id:
                    ...
                    msg += _validate_long(rec.identification_id, rec.type_identification_id.doc_length, type_document_partner,
                                          u'Número Documento')
                    msg += _validate_word_structure(rec.identification_id, rec.type_identification_id.doc_type, u'Número Documento')
