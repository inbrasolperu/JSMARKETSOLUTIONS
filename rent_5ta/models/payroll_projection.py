...
def get_months_to_update(vals):
    data = []
    if 'january_amount' in vals:
        data.append('01')
    elif 'february_amount' in vals:
        data.append('02')
    elif 'march_amount' in vals:
        data.append('03')
    elif 'april_amount' in vals:
        data.append('04')
    elif 'may_amount' in vals:
        data.append('05')
    elif 'june_amount' in vals:
        data.append('06')
    elif 'july_amount' in vals:
        data.append('07')
    elif 'august_amount' in vals:
        data.append('08')
    elif 'september_amount' in vals:
        data.append('09')
    elif 'october_amount' in vals:
        data.append('10')
    elif 'november_amount' in vals:
        data.append('11')
    elif 'december_amount' in vals:
        data.append('12')
    return data
