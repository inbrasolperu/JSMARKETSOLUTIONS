...
class HrPayslip(models.Model):
    ...
    def _get_worked_day_lines(self):
        ...
        if self.contract_id.resource_calendar_id:
            ...
            dias_010_amount = self._get_calc_amount_per_entry(dias_010_hours, total_hours, dias_010_entry_type_id)
            values = [{
                'sequence': dias_010_entry_type_id.sequence, 'work_entry_type_id': dias_010_entry_type_id.id, 'number_of_days': dias_010_days,
                'number_of_hours': dias_010_hours, 'amount': dias_010_amount
            }]
            res += values
        return res
