...
class HrPayslip(models.Model):
    ...
    def _get_worked_day_lines(self):
        ...
        if self.contract_id.resource_calendar_id:
            ...
            if service_start_date:
                ...
                total_hours = sum(line['amount'] for line in res)
                ...
                tdi_001_amount = self._get_calc_amount_per_entry(tdi_001_hours, total_hours, tdi_001_entry_type_id)
                ...
                tdi_002_amount = self._get_calc_amount_per_entry(tdi_002_hours, total_hours, tdi_002_entry_type_id)
                ...
                tdl_001_amount = self._get_calc_amount_per_entry(tdl_001_hours, total_hours, tdl_001_entry_type_id)
                ...
                tdl_002_amount = self._get_calc_amount_per_entry(tdl_002_hours, total_hours, tdl_002_entry_type_id)
                ...
                tdm_001_amount = self._get_calc_amount_per_entry(tdm_001_hours, total_hours, tdm_001_entry_type_id)
                ...
                if tmp_periods and service_start_date.strftime('%Y') == tmp_periods[0][3:] and \
                    ...
                    if service_start_date.strftime('%d') == '01':
                ...
                dias_003_amount = self._get_calc_amount_per_entry(dias_003_hours, total_hours, dias_003_entry_type_id)
                ...
                dias_002_amount = self._get_calc_amount_per_entry(dias_002_hours, total_hours, dias_002_entry_type_id)
                ...
                mes_001_amount = self._get_calc_amount_per_entry(mes_001_hours, total_hours, mes_001_entry_type_id)
                ...
                mes_002_amount = self._get_calc_amount_per_entry(mes_002_hours, total_hours, mes_002_entry_type_id)
                ...
                mes_003_amount = self._get_calc_amount_per_entry(mes_003_hours, total_hours, mes_003_entry_type_id)
    ...
    def _get_calc_amount_per_entry(self, entry_hours, total_hours, entry_type_id):
        if total_hours == 0:
            return 0
        unpaid_work_entry_types = self.struct_id.unpaid_work_entry_type_ids.ids
        paid_amount = self._get_contract_wage()
        amount = entry_hours * paid_amount / total_hours if entry_type_id.id not in unpaid_work_entry_types else 0
        return amount
