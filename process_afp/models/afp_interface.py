        ...
        for obj in self:
            ...
            for employee in employees:
                ...
                if employee.pension_system_id and employee.pension_system_id.cuspp:
                    if employee.type_identification_id and employee.type_identification_id.code in ['1', '4', '7']:
                        if employee.type_identification_id.code == '1':
                            document_type_id = '0'
                        elif employee.type_identification_id.code == '4':
                            document_type_id = '1'
                        else:
                            document_type_id = '4'
                    else:
